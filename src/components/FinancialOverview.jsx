...
const FinancialOverview = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-purple-900/95 via-purple-800/85 to-purple-950/98 dark:from-purple-950/95 dark:via-purple-900/85 dark:to-black/98 backdrop-blur-2xl rounded-3xl p-6 md:p-8 shadow-xl shadow-purple-900/20 border border-purple-500/30 text-white w-full transition-all duration-300 space-y-6">
      ...
      <div className="relative z-10 flex items-center gap-4 sm:gap-6 pb-6 border-b border-white/10">
